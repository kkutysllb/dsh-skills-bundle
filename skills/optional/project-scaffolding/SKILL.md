...
description: Use this skill when creating a new project structure, package layout, initial app skeleton, routes, service layers, test directories, or starter configuration.
---
