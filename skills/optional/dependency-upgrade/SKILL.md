...
description: Use this skill for dependency upgrades, package manager changes, vulnerability remediation, lockfile updates, SDK migrations, and version compatibility work.
---
