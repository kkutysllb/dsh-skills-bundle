...
description: Use this orchestration skill when starting a project from requirements and carrying it through design, scaffolding, implementation, validation, review, documentation, deployment, and handoff.
---
