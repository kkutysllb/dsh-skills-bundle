...
description: Use this skill for frontend or backend state design, query caches, mutation invalidation, session state, optimistic updates, task state, and stale data.
---
