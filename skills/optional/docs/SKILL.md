---
name: docs
description: Use this skill when writing or updating developer docs, README sections, API docs, architecture notes, changelogs, inline usage examples, or migration guidance.
---
