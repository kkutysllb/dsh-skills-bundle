---
name: deployment
description: Use this skill when preparing deployment, hosting configuration, environment variables, build artifacts, release rollout, smoke checks, or rollback strategy.
---
