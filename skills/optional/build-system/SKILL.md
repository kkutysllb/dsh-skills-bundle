---
name: build-system
description: Use this skill for build tooling, package scripts, monorepo workspaces, bundlers, TypeScript compilation, Python packaging, task runners, and build failures.
---
