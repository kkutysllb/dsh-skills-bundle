...
description: Use this skill when producing code patches, one-click fixes, deterministic automatic fixes, minimal diffs, stale-safe replacements, or applyable changes.
---
