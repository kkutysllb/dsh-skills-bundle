...
description: Use this skill when implementing a feature end-to-end through UI, API, service, persistence, tests, and documentation in small reviewable slices.
---
