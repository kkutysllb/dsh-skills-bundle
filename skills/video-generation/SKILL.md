...
```bash
python $DSH_HOME/profiles/web/node_modules/dsh-skills-bundle/skills/video-generation/scripts/generate.py \
...
```bash
python $DSH_HOME/profiles/web/node_modules/dsh-skills-bundle/skills/video-generation/scripts/generate.py \
  --prompt-file ./narnia-farewell-scene.json \
