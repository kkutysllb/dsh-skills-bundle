...
Generate a structured JSON script file in `./` with naming pattern: `{descriptive-name}-script.json`
...
```bash
python $DSH_HOME/profiles/web/node_modules/dsh-skills-bundle/skills/podcast-generation/scripts/generate.py \
  --script-file ./script-file.json \
...
```bash
python $DSH_HOME/profiles/web/node_modules/dsh-skills-bundle/skills/podcast-generation/scripts/generate.py \
  --script-file ./ai-history-script.json \
